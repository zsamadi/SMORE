...
% Things you need to consider for each datase
% 1. where gene expression starts
% 
% 
% 2. sampling frequency


    % dataFolder.input='mouse_embryo.csv';
    dataFolder.input='mouse3_embryo_NMPs.csv';
    dataFolder.gexFilename='sprsGenEx.h5';
    dataFolder.gAnotFilename='geneNames.txt';
    dataFolder.output='output/mouse3_embryo';
    options.nMotifs=5;
    options.WMotif=4;
    
    options.gMode='delaunay'; % knn, delaunay
    options.ND=0;
    options.nNeighs=6;
    options.rEps=0;
    options.samplingFreq=0.1;
    ...
    options.doGEA=true;
    options.iSPGEx=true;
    options.gePvalMin=1e-3;
    options.geRandTest=false;
    options.isGEByTissue=true;
...
if isRunURPENSmore
    ...
    % output forlder name and appropriate specs
    % outputFolderName='D:\nucla\P1\mcodes\SMORE\output\mouse3_embryo\13-Oct-2024/';%
    % |^| This one is knn
    

    % outputFolderName='D:\nucla\P1\mcodes\SMORE\output\mouse3_embryo\26-Oct-2024/';
    outputFolderName='D:\nucla\P1\mcodes\SMORE\output\mouse3_embryo\24-Oct-2024_NOMrg/';
