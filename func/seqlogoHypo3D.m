function [W, hfig, cTypeChars] = seqlogoHypo3D(motif, varargin)
...
%   is log2(4) bits for DNA/RNA and log2(68) bits for proteins. SEQS is a
...
%   by SEQPROFILE. P is a matrix of size [68 x seq Length] with the
